...
class UserFeedList {
  ...
  UserFeedList({this.success, this.message, this.data});
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if(json["data"] is List) {
      data = json["data"] == null ? null : (json["data"] as List).map((e) => UserList.fromJson(e)).toList();
    }
...
class UserList {
  ...
  UserList({this.id, this.userId, this.location, this.lng, this.lat, this.description, this.viewStatus, this.deletedAt, this.createdAt, this.updatedAt, this.feedUserInfo, this.getFeedImages, this.isLiked, this.totalComments, this.totalLikes});
  ...
  UserList.fromJson(Map<String, dynamic> json) {
    ...
    if(json["feed_user_info"] is Map) {
      feedUserInfo = json["feed_user_info"] == null ? null : FeedUserInfo.fromJson(json["feed_user_info"]);
    }
    if(json["get_feed_images"] is List) {
      getFeedImages = json["get_feed_images"] == null ? null : (json["get_feed_images"] as List).map((e) => GetFeedImages.fromJson(e)).toList();
    }
...
class FeedUserInfo {
  ...
  FeedUserInfo({this.id, this.firstname, this.lastname, this.email, this.emailVerifiedAt, this.phoneNumber, this.phoneNumberVerifiedAt, this.dob, this.gender, this.profilePic, this.description, this.otp, this.confirmationToken, this.authToken, this.deviceToken, this.profileStep, this.isVerified, this.isDeleted, this.createdAt, this.updatedAt, this.cardId, this.customerId, this.timezone, this.roleId, this.deletedAt});
