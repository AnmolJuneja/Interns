class CatchLikeList {
  ...
  CatchLikeList({this.success, this.message, required this.data});

  CatchLikeList.fromJson(Map<String, dynamic> json) {
    ...
    if (json["data"] is List) {
      data = (json["data"] == null
          ? null
          : (json["data"] as List).map((e) => DataCLike.fromJson(e)).toList())!;
    }
  }
...
class DataCLike {
  ...
  DataCLike.fromJson(Map<String, dynamic> json) {
    if (json["id"] is int) {
      id = json["id"];
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["sportlight_id"] = sportlightId;
    _data["type"] = type;
    _data["status"] = status;
