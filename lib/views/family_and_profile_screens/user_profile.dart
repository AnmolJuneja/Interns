                                ...
                                child: Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Obx(() => Text20PtBold(
                                            text: ff.follow.value.toString())),
                                      )
                                    ]),
                              ),
                              Padding(
...
Widget buildImage(MyFeed userList) {
  return GestureDetector(
    onTap: () {
      Get.to(() => FeedDetails1UI(feedId: userList.id!.toInt()));
    },
    child: Container(
      height: 170.h,
      width: 170.w,
