  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
        ...
        child: Scaffold(
            ...
            body: Stack(children: [
              Positioned(
                  top: Platform.isAndroid ? 155.2.h : 146.4.h,
                  child:
                      Container(height: 2.h, width: 500.w, color: Colors.grey)),
              Column(children: [
                Padding(
                    padding:
                        EdgeInsets.only(top: 24.h, left: 36.w, right: 32.w),
                    child: Column(
                              ...
                              child: Padding(
                                  ...
                                  child: Column(children: [
                                    Post(
                                        ...
                                        commentImage:
                                            'assets/images/Group 206.png',
                                        commentText: '12',
                                        shareImage:
                                            'assets/images/Group 207.png'),
