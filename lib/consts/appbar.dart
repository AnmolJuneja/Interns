...
class AppBAddCatch extends StatelessWidget {
  String? title;
  IconData? secondIcon;
  IconData? firstIcon;
  VoidCallback ontap;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
        GestureDetector(
            onTap: ontap,
            child: Icon(firstIcon, color: const Color(0xff2B67A3))),
        SizedBox(width: 20.w),
        Center(
          child: Text(title!,
              style: TextStyle(
...
class AppBarCatchDetails extends StatelessWidget {
  String? title;
  IconData? secondIcon;
  IconData? firstIcon;
  VoidCallback ontap;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
        GestureDetector(
            onTap: ontap, child: Icon(firstIcon, color: Colors.black)),
        SizedBox(width: 88.w),
        Text(title!,
            style: TextStyle(
                fontFamily: 'Helvetica',
